...
class TestPrintFormatter:
    ...
    def test_whole_formatter(self):
        ...
        expected_output = new_pdf_print_format
        assert actual_output == expected_output


new_pdf_print_format = """
...
[^http://inventos-sub.com/]: http://inventos-sub.com/
...
[^http://proterva-scilicet.org/ille.php]: http://proterva-scilicet.org/ille.php
...
[^http://cautes.org/alcithoe.html]: http://cautes.org/alcithoe.html
...
[^http://www.mills.com/ut-rem-dolorem-velit-similique-consequuntur-deleniti-consectetur-adipiscing-elit.html]: http://www.mills.com/ut-rem-dolorem-velit-similique-consequuntur-deleniti-consectetur-adipiscing-elit.html
...
[^http://lampades.com/vulnere-harenae]: http://lampades.com/vulnere-harenae
...
[^http://quotiens.net/terras.html]: http://quotiens.net/terras.html
...
[^http://harenam-pelops.org/gemellam]: http://harenam-pelops.org/gemellam
