from src.manuscriptFormatter import get_formatted_manuscript_stream_for_epub, get_formatted_manuscript_stream_for_print
...
class TestFormatter:
    ...
    def test_new_pdf_format(self):
        assert get_formatted_manuscript_stream_for_print().read().decode() == old_pdf_format
